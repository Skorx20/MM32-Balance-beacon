...
typedef enum																		// 枚举定时器模块 此枚举定义不允许用户修改
{
	...
	TIM_1					= 0x1000,		//	摄像头											// 0x1000[APB2]	0x0000[APB_EN BIT] 0x0000[TIM index]
	...
	TIM_5					= 0x0033,		//	电机												// 0x0000[APB1]	0x0030[APB_EN BIT] 0x0003[TIM index]

	// General Timer 16 bits
	TIM_3					= 0x0014,		//	编码器										// 0x0000[APB1]	0x0010[APB_EN BIT] 0x0004[TIM index]
	TIM_4					= 0x0025,		//	编码器										// 0x0000[APB1]	0x0020[APB_EN BIT] 0x0005[TIM index]
