...
// @return		void
// Sample usage:				tim_encoder_init(TIM_1, PULSEA_pin, PULSEB_pin);
//-------------------------------------------------------------------------------------------------------------------
...
// @brief		encoder 复位计数器
// @param		tim				选择 encoder 使用的 TIM
// Sample usage:				tim_encoder_rst(TIM_1);
//-------------------------------------------------------------------------------------------------------------------
...
// @param		tim				选择 encoder 使用的 TIM
// Sample usage:				temp = tim_encoder_rst(TIM_1);
//-------------------------------------------------------------------------------------------------------------------
...
// @return		void			NULL
// Sample usage:				tim_counter_pin_init(TIM_1);
//-------------------------------------------------------------------------------------------------------------------
...
// @brief		counter 复位计数器
// @param		tim				选择 counter 使用的 TIM
// Sample usage:				tim_counter_rst(TIM_1);
//-------------------------------------------------------------------------------------------------------------------
...
// @param		tim				选择 counter 使用的 TIM
// Sample usage:				temp = tim_counter_get_count(TIM_1);
//-------------------------------------------------------------------------------------------------------------------
